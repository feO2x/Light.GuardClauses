...
namespace Light.GuardClauses.Tests.FrameworkExtensions
{
    ...
    {
        [Theory]
        [InlineData(MetasyntacticVariables.Foo, 42)]
        [InlineData(MetasyntacticVariables.Bar, -177422)]
        [InlineData(null, 0)]
        ...
        [Theory]
        [InlineData(MetasyntacticVariables.Foo, 42, 'a')]
        [InlineData(MetasyntacticVariables.Bar, -177422, 'Y')]
        ...
        [Theory]
        [InlineData(MetasyntacticVariables.Foo, 42, 'a', 87.73665)]
        [InlineData(MetasyntacticVariables.Bar, -177422, 'Y', -15.25)]
