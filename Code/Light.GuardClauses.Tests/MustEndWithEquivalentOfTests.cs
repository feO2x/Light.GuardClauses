...
namespace Light.GuardClauses.Tests
{
    ...
    {
        [Theory(DisplayName = "MustEndWithEquivalentOf must throw a StringException when the string does not end with the specified text (ignoring case-sensitivity).")]
        [InlineData("Foo", "Bar")]
        ...
        [Theory(DisplayName = "MustEndWithEquivalentOf must not throw an exception when the string ends with the specified text (ignoring case-sensitivity).")]
        ...
        [Theory(DisplayName = "MustEndWithEquivalentOf must throw an ArgumentNullException when either paramter or text is null.")]
        [InlineData(null, "Foo")]
        [InlineData("Foo", null)]
        ...
        public void PopulateTestDataForCustomExceptionAndCustomMessageTests(CustomMessageAndExceptionTestData testData)
        {
            ...
            testData.Add(new CustomMessageTest<StringException>(message => "The Drowned God wants his enemies drowned".MustEndWithEquivalentOf("altruism", message: message)));
        }
    }
}