...
public static class Throw
{
    ...
    [ContractAnnotation("=> halt")]
    [DoesNotReturn]
    public static void MustNotBeLessThan<T>(
        T parameter,
        T boundary,
        [CallerArgumentExpression("parameter")] string? parameterName = null,
        string? message = null
        ...
        throw new ArgumentOutOfRangeException(
            parameterName,
            message ??
            $"{parameterName ?? "The value"} must not be less than {boundary}, but it actually is {parameter}."
        );
    ...
    [ContractAnnotation("=> halt")]
    [DoesNotReturn]
    public static void MustNotBeGreaterThanOrEqualTo<T>(
        T parameter,
        T boundary,
        [CallerArgumentExpression("parameter")] string? parameterName = null,
        string? message = null
        ...
        throw new ArgumentOutOfRangeException(
            parameterName,
            message ??
            $"{parameterName ?? "The value"} must not be greater than or equal to {boundary}, but it actually is {parameter}."
        );
    ...
    [ContractAnnotation("=> halt")]
    [DoesNotReturn]
    public static void MustBeGreaterThanOrEqualTo<T>(
        T parameter,
        T boundary,
        [CallerArgumentExpression("parameter")] string? parameterName = null,
        string? message = null
        ...
        throw new ArgumentOutOfRangeException(
            parameterName,
            message ??
            $"{parameterName ?? "The value"} must be greater than or equal to {boundary}, but it actually is {parameter}."
        );
    ...
    [ContractAnnotation("=> halt")]
    [DoesNotReturn]
    public static void MustNotBeGreaterThan<T>(
        T parameter,
        T boundary,
        [CallerArgumentExpression("parameter")] string? parameterName = null,
        string? message = null
        ...
        throw new ArgumentOutOfRangeException(
            parameterName,
            message ??
            $"{parameterName ?? "The value"} must not be greater than {boundary}, but it actually is {parameter}."
        );
    ...
    [ContractAnnotation("=> halt")]
    [DoesNotReturn]
    public static void MustBeLessThanOrEqualTo<T>(
        T parameter,
        T boundary,
        [CallerArgumentExpression("parameter")] string? parameterName = null,
        string? message = null
        ...
        throw new ArgumentOutOfRangeException(
            parameterName,
            message ??
            $"{parameterName ?? "The value"} must be less than or equal to {boundary}, but it actually is {parameter}."
        );
    ...
    public static void InvalidSpanLength<T>(
        ...
        throw new InvalidCollectionCountException(
            parameterName,
            message ??
            $"{parameterName ?? "The span"} must have length {length}, but it actually has length {parameter.Length}."
        );
    ...
    [ContractAnnotation("=> halt")]
    [DoesNotReturn]
    public static void ValueIsOneOf<TItem>(
        TItem parameter,
        IEnumerable<TItem> items,
        [CallerArgumentExpression("parameter")] string? parameterName = null,
        string? message = null
