...
namespace Light.GuardClauses
{
    ...
    {
        /// <summary>
        ///     Ensures that the specified URI is an absolute one, or else throws an <see cref="ArgumentException" />.
        /// </summary>
        ...
        public static void MustBeAbsoluteUri(this Uri uri, string parameterName = null, string message = null, Func<Exception> exception = null)
        {
            ...
            throw exception != null ? exception() : new ArgumentException(message ?? $"{parameterName ?? "The uri"} must be an absolute URI, but you specified \"{uri}\".");
        }
    }
}