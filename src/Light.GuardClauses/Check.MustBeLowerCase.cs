...
public static partial class Check
{
    ...
    public static string MustBeLowerCase(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Span<char> MustBeLowerCase(
    ...
    public static ReadOnlySpan<char> MustBeLowerCase(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Memory<char> MustBeLowerCase(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReadOnlyMemory<char> MustBeLowerCase(
