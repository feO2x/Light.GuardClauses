...
public static partial class Check
{
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static byte MustNotBePositive(
        this byte parameter,
        [CallerArgumentExpression("parameter")] string? parameterName = null,
        string? message = null
    )
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static short MustNotBePositive(
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ushort MustNotBePositive(
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static uint MustNotBePositive(
        this uint parameter,
        [CallerArgumentExpression("parameter")] string? parameterName = null,
        string? message = null
    )
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ulong MustNotBePositive(
